  ...
  <div class="container">
    ...
    <div class="card m-5 ">
      <div class="card-header">
        <h1>Thank you for claiming artist profile</h1>
      </div>
      <div class="card-body">
        <div class="row m-5">
          <div class="col font-weight-bold">
            Your request is not approve yet, but our team approve it base on our terms & conditions.
          </div>
        </div>
        <div class="row ml-2">
          <a href="http://127.0.0.1:8000/">Go to site.</a>
        </div>
