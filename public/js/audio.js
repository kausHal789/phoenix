...
function setMute() {
  ...
  var imgSrc = audio.muted ? '/storage/icons/volume-mute.png' : '/storage/icons/volume.png';
  $('#volumeButton').find('img').attr('src', imgSrc);
}

function setShuffle() {
  shuffle = !shuffle;
  var imgSrc = shuffle ? '/storage/icons/shuffle-active.png' : '/storage/icons/shuffle.png';
  $('#shuffleButton').find('img').attr('src', imgSrc);
...
function repeatTrack() {
  repeat = !repeat;
  var imgSrc = repeat ? '/storage/icons/repeat-active.png' : '/storage/icons/repeat.png';
  $('#repeatTrackButton').find('img').attr('src', imgSrc);
}
